...
La cryptographie à clé publique est depuis ??? dominée par RSA et DH. Mais ces systèmes ne sont pas quantiquement sûrs. Or l'éventualité de l'arrivée dans les décénies à venir de l'ordinateur quantique impose la recherche d'alternatives à RSA et DH.\\
- Appel d'offre NIST \\
Le papier sur lequel nous avons travaillé se pose donc dans ce contexte. Il propose un système de signature à base de code correcteurs. Les codes correcteurs, proposés depuis les années 70 pour le chiffrement (ex: crypto-système de McEliece) présentent une alternative quantiquement sûr puisqu'ils reposent sur le problème du décodage, un problème NP-complet. En revanche, les recherches pour utiliser des codes dans des systèmes de signatures sont peu concluantes, en témoigne le tableau des soumissions au NIST pour le second tour. \\
...
EXPLIQUER SYNDROME GPVM blablabla \\
